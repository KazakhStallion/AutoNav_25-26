#!/usr/bin/env python3
"""
t003_automater.py - Test 003 Automater
...
class T003Automater(Node):
    def __init__(self):
        super().__init__('t003_automater')
        
        # Test configuration
        self.test_id = 't003'
        self.test_name = 'Forward_Move'
    ...
    # ===== Everything within these lines are specific to the t003 test ===== #
