...
'''
Launch script for [TEST ID: t003] Forward Movement automated test.
...
3. Execute the t003_automator.py script to manage the test
'''
...
def generate_launch_description():
    ...
    with open(test_data_config, 'r') as f:
        ...
        topics_to_monitor = data_publisher_params.get('t003', [])
    ...
    # ===== Lines below here are specific to the t003 test ===== #
