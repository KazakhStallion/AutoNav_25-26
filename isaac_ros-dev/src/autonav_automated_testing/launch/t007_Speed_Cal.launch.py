...
def generate_launch_description():
    ...
    # NOTE: t007 uses custom CSV format generated by automator, not standard data_publisher format
    # The automator calculates speed from encoder deltas and writes custom CSV rows

    # [NODES] #
    # Control node is needed to receive /motor/cmd_value and drive motors
    # TODO: Add control_dev.launch.py include once control node supports /motor/cmd_value topic
