...
'''
Launch script for [TEST ID: t007] Speed Calibration automated test.
...
def generate_launch_description():
    ...
    with open(test_data_config, 'r') as f:
        ...
        topics_to_monitor = data_publisher_params.get('t007', [])
    ...
    # ===== Lines below here are specific to the t007 test ===== #
    # NOTE: t007 requires control node to be running for:
    # - /motor/cmd_value subscription (raw motor commands for calibration)
    # - /motor/linear_velocity publication (velocity calculated from encoders)
    # 
    # Make sure to launch control_dev.launch.py separately before running this test
