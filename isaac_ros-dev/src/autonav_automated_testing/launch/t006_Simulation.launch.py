...
'''
Launch script for [TEST ID: t006] Simulation automated test.
...
3. Execute the t006_automater.py script to manage the test
'''
...
def generate_launch_description():
    ...
    with open(test_data_config, 'r') as f:
        ...
        topics_to_monitor = data_publisher_params.get('t006', [])
    ...
    # ===== Lines below here are specific to the t006 test ===== #
