...
'''
Launch script for [TEST ID: t008] Acceleration automated test.
...
def generate_launch_description():
    ...
    with open(test_data_config, 'r') as f:
        ...
        topics_to_monitor = data_publisher_params.get('t008', [])
    ...
    # ===== Lines below here are specific to the t008 test ===== #
