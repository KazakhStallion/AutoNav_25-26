...
'''
Launch script for [TEST ID: t005] Path Planning automated test.
...
3. Execute the t005_automater.py script to manage the test
'''
...
def generate_launch_description():
    ...
    with open(test_data_config, 'r') as f:
        ...
        topics_to_monitor = data_publisher_params.get('t005', [])
    ...
    # ===== Lines below here are specific to the t005 test ===== #
