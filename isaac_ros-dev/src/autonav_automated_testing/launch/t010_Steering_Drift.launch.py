...
'''
Launch script for [TEST ID: t010] Steering Drift automated test.
...
3. Execute the t010_automator.py script to manage the test
'''
...
def generate_launch_description():
    ...
    with open(test_data_config, 'r') as f:
        ...
        topics_to_monitor = data_publisher_params.get('t010', [])
    ...
    # ===== Lines below here are specific to the t010 test ===== #
