...
'''
Launch script for [TEST ID: t009] Rotation automated test.
...
3. Execute the t009_automater.py script to manage the test
'''
...
def generate_launch_description():
    ...
    with open(test_data_config, 'r') as f:
        ...
        topics_to_monitor = data_publisher_params.get('t009', [])
    ...
    # ===== Lines below here are specific to the t009 test ===== #
